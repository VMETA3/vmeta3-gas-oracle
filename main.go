...
import (
	...
	"github.com/VMETA3/vmeta3-chain/vmeta3/gas-oracle/flags"
	ometrics "github.com/VMETA3/vmeta3-chain/vmeta3/gas-oracle/metrics"
	"github.com/VMETA3/vmeta3-chain/vmeta3/gas-oracle/oracle"
...
func main() {
	...
	app.Name = "gas-oracle"
	app.Usage = "Remotely Control the Vmeta3 Gas Price"
	app.Description = "Configure with a private key and an Vmeta3 HTTP endpoint " +
