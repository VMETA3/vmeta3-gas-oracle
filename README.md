...
```
NAME:
   gas-oracle - Remotely Control the Vmeta3 Gas Price
...
DESCRIPTION:
   Configure with a private key and an Vmeta3 HTTP endpoint to send transactions that update the L2 gas price.
